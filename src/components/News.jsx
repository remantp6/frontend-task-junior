...
const News = () => {
  return (
    <div className="container mx-auto">
      <h2 className="text-white text-4xl font-bold pb-10 lg:pb-16 text-center">
        News
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-white">
        <div className="bg-[#7b7b7e] backdrop-filter backdrop-blur-lg bg-opacity-15 rounded-lg h-[300px]">
          ...
          <div className="ps-2 py-3">
            ...
            <p className="text-[16px] font-semi-bold pb-1">March 12, 2024</p>
          </div>
        </div>
        <div className="bg-[#7b7b7e] backdrop-filter backdrop-blur-lg bg-opacity-15 rounded-lg">
          ...
          <div className="ps-2 py-3">
            ...
            <p className="text-[16px] font-semi-bold pb-1">March 16, 2024</p>
          </div>
        </div>
        <div className="bg-[#7b7b7e] backdrop-filter backdrop-blur-lg bg-opacity-15 rounded-lg">
          <img
          ...
          />
          <div className="ps-2 py-3">
            <h3 className="text-lg font-semi-bold">Industry Recognition...</h3>
            <p className="text-[16px] font-semi-bold pb-2">April 2, 2024</p>
          </div>
        </div>
      </div>
    </div>
